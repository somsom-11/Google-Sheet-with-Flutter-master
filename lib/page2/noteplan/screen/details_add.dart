import 'package:Google_Sheet_with_Flutter/page2/noteplan/bloc.dart';
            ...
            child: Scaffold(
              appBar: AppBar(
                title: isEditing == false           // --> เลือกระหว่างจะโชว์ Text หรือ TextFormField
                  ...
                  decoration: InputDecoration(
                      ...
                      labelStyle: TextStyle(fontSize: 20.0,fontWeight: FontWeight.bold,fontFamily: 'CSPrajad'),hintStyle:
                  TextStyle(fontFamily: 'CSPrajad',fontWeight: FontWeight.bold,fontSize: 20.0)),
              ...
              body: Container(
                  ...
                  child: isEditing == false                                                   // --> เลือกระหว่างจะโชว์ Text หรือ TextFormField
                    ...
                    decoration: InputDecoration(
                        hintText: 'Any Detail you want to put',labelStyle:
                    TextStyle(fontFamily: 'CSPraJad',fontSize: 20.0,fontWeight: FontWeight.bold),
                        labelText: 'Detail'),
